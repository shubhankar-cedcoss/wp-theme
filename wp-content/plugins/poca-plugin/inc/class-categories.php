 ...
 * @see WP_Widget
 */
class WP_Custom_Categories extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'categories_custom', __( 'Categories_of_my_site' ), $widget_ops );
	}
...
add_action(
	'widgets_init',
	function() {
		register_widget( 'WP_Custom_Categories' );
	}
);